...
bool parseBitcoinURI(const QUrl &uri, SendCoinsRecipient *out)
{
    ...
    if(uri.scheme() != QString("monerotrust"))
        return false;
...
bool parseBitcoinURI(QString uri, SendCoinsRecipient *out)
{
    ...
    if(uri.startsWith("monerotrust://"))
    {
        uri.replace(0, 12, "monerotrust:");
    }
...
HelpMessageBox::HelpMessageBox(QWidget *parent) :
    QMessageBox(parent)
{
    header = tr("MoneroTrust-Qt") + " " + tr("version") + " " +
    ...
    setWindowTitle(tr("MoneroTrust-Qt"));
